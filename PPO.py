...
class PPO:
    def __init__(self, action_dim, lr, betas, gamma, K_epochs, eps_clip):
        self.lr = lr
        self.betas = betas
        self.gamma = gamma
...
max_episodes = 1400        # max training episodes
...
memory = Memory()
ppo = PPO(action_dim, lr, betas, gamma, K_epochs, eps_clip)
print(lr,betas)
